...
def add_generated_surface(node, name, positions, triangles, color, mechanical=False, texture=None, texcoords=None, material=None):
    ...
    if mechanical:
        child.addObject("UniformMass", totalMass=0.04)
        child.addObject("TriangleFEMForceField", name="fem", youngModulus=650.0, poissonRatio=0.43, method="large")
        child.addObject("TriangularBendingSprings", name="bending", stiffness=0.08, damping=0.02)
